              ...
              {post.images.map((url, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <span className="text-white font-bold text-sm tracking-wide drop-shadow-md bg-black/40 backdrop-blur-md px-4 py-1.5 rounded-full border border-white/10">클릭하여 확대</span>
                  </div>
                </div>
              ))}
            </div>
